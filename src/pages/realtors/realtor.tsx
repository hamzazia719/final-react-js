...
// import { fetchRealtor } from '../../store/slicer/realtor';
...
//       <h1 className="text-2xl font-bold mb-4">Realtor List</h1>
...
//             <p className="text-gray-700">Address: {agent.street}, {agent.city}, {agent.state}, {agent.zipcode}</p>
//           </div>
//         ))}
//       </div>
//     </div>
